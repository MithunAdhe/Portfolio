...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Mithun Adhe Portfolio";
...
var typed = new Typed(".typing-text", {
    strings: ["Data Analysis","Machine Learning", "Data Science", "Artificial Intelligence", "Deep Learning", ,"Natural Language Processing", "Generative AI"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
